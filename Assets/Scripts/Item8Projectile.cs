...
public class Item8Projectile : Projectile
{
	...
	private void OnTriggerEnter2D(Collider2D other)
	{
		...
		if (tt)
		{
			if (!this.isInCollision)
			{
				...
				GameObject pooledObject = ParticleObjectPooler.instance.GetPooledObject("item8_particle");
		...
		if (other.tag == "Ground")
		{
			if (!this.isInCollision)
			{
				...
				GameObject pooledObject2 = ParticleObjectPooler.instance.GetPooledObject("item8_particle");
