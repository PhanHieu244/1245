...
public class ParticleUpgradeLevelManager : MonoBehaviour
{
	private sealed class _CheckIfAlive_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		internal ParticleUpgradeLevelManager _this;
	...
	{
		ParticleUpgradeLevelManager._CheckIfAlive_c__Iterator0 _CheckIfAlive_c__Iterator = new ParticleUpgradeLevelManager._CheckIfAlive_c__Iterator0();
